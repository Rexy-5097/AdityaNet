"""
scripts/sprint31/train_driver.py

Sprint 31 (path-only copy of the Sprint 30 driver; run dir moves to sprint31) — the Sprint 26 faithful V1 trainer with EXACTLY TWO changes,
