...
async def main() -> None:
    parser = argparse.ArgumentParser(description="SuryaNet GOES Telemetry Backfill CLI")
    parser.add_argument(
        "--start-date",
        type=str,
        default="2010-01-01",
    ...
    print("==================================================")
    print("SuryaNet: GOES Telemetry Historical Backfill")
    ...
    try:
        ...
        print("\nGOES Backfill Successful!")
    except Exception as e:
        print(f"\nERROR: GOES Backfill failed: {e}")
        sys.exit(1)
